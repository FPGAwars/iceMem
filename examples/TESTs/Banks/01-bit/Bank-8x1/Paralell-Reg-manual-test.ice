{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "976e09c9-82cb-4535-a4f7-c69091db1c3b",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[7:0]",
        ...
        {
          "id": "3c76be73-4e1c-441c-b346-9763f2d2c5ae",
          "type": "basic.outputLabel",
          "data": {
            "name": "addr",
            "range": "[2:0]",
        ...
        {
          "id": "84b402bc-87da-43ac-bf07-6fb7e22748ad",
          "type": "basic.inputLabel",
          "data": {
            "name": "addr",
            "range": "[2:0]",
        ...
        {
          "id": "eae5b055-a077-4b91-baad-8fb4315cff79",
          "type": "132fe8c361df06a587e0e4220d67fc03504ea0bf",
          "position": {
            "x": 624,
            "y": 168
          },
        ...
        {
          "id": "8700df57-9c1d-4a84-a1d7-4568bc542b62",
        ...
        {
          "id": "235981bb-d31d-463f-834d-092239518f41",
          "type": "5018a67fe520592d7f82dbf669bb3c3661624b65",
          "position": {
            "x": -216,
            "y": 304
        ...
        {
          "id": "ca80629e-e8a6-4167-8cd2-5928cc1ba973",
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "eae5b055-a077-4b91-baad-8fb4315cff79",
        ...
        },
        {
          "source": {
            "block": "eae5b055-a077-4b91-baad-8fb4315cff79",
            "port": "c2c79631-d13e-41f4-97ce-c806ed816598"
          },
          "target": {
            "block": "976e09c9-82cb-4535-a4f7-c69091db1c3b",
            "port": "in"
          },
          "vertices": [
            {
        ...
        {
          "source": {
            "block": "3c76be73-4e1c-441c-b346-9763f2d2c5ae",
            "port": "outlabel"
          },
          "target": {
            "block": "eae5b055-a077-4b91-baad-8fb4315cff79",
            "port": "5b45b3d0-e72c-4dd0-af5a-55af58767e7f"
          },
          "size": 3
        },
        {
          "source": {
            "block": "ca80629e-e8a6-4167-8cd2-5928cc1ba973",
            "port": "5d77943b-f29b-4e84-86e0-c151bc1454bb"
          },
          "target": {
            "block": "84b402bc-87da-43ac-bf07-6fb7e22748ad",
            "port": "inlabel"
          },
          "size": 3
        },
        {
          ...
          "target": {
            "block": "8700df57-9c1d-4a84-a1d7-4568bc542b62",
        ...
        },
        {
          ...
          "target": {
            "block": "235981bb-d31d-463f-834d-092239518f41",
            "port": "21bc142d-a93a-430d-b37a-326435def9f9"
          }
        },
        {
  ...
  "dependencies": {
    ...
    "132fe8c361df06a587e0e4220d67fc03504ea0bf": {
      "package": {
        "name": "Bank-8x1-paralell",
        "version": "0.1",
        "description": "Bank of 8 registers of 1 bits with paralell output (implemented in verilog)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "c2c79631-d13e-41f4-97ce-c806ed816598",
              "type": "basic.output",
              "data": {
                "name": "paralell",
                "range": "[7:0]",
            ...
            {
              "id": "08e151ac-ddc9-4d61-9862-160e65e356ba",
              "type": "basic.outputLabel",
              "data": {
                "name": "addr",
                "range": "[2:0]",
            ...
            {
              "id": "e5cd9c0f-0696-49af-99c4-df815c081072",
              "type": "basic.inputLabel",
              "data": {
                "name": "addr",
                "range": "[2:0]",
            ...
            {
              "id": "5b45b3d0-e72c-4dd0-af5a-55af58767e7f",
              "type": "basic.input",
              "data": {
                "name": "addr",
                "range": "[2:0]",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "08e151ac-ddc9-4d61-9862-160e65e356ba",
                "port": "outlabel"
              },
              "target": {
                "block": "f67e4c13-cb1a-4f3f-95aa-0b1768893b03",
            ...
            {
              "source": {
                "block": "5b45b3d0-e72c-4dd0-af5a-55af58767e7f",
                "port": "out",
                "size": 3
              },
              "target": {
                "block": "e5cd9c0f-0696-49af-99c4-df815c081072",
                "port": "inlabel"
              },
              "size": 3
            },
            ...
            },
            {
              ...
              "target": {
                "block": "c2c79631-d13e-41f4-97ce-c806ed816598",
                "port": "in"
              },
              "size": 8
            }
