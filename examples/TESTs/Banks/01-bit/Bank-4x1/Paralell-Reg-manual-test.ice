{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "ce0bb6e1-53ec-4758-b201-e1354c2e1277",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[3:0]",
        ...
        {
          "id": "96455e70-8559-4650-ae2a-80fb4d046cb0",
          "type": "d9c67be24d4a8c4c5416df39f3731d1307e553b7",
          "position": {
            "x": 624,
            "y": 168
          },
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "The data to be written is  \nthe current data negated",
            "readonly": true
          },
          "position": {
            "x": 96,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "96455e70-8559-4650-ae2a-80fb4d046cb0",
        ...
        },
        {
          "source": {
            "block": "96455e70-8559-4650-ae2a-80fb4d046cb0",
            "port": "8872e5d9-8f6d-4096-94b9-3b6cb1f7ea4e"
          },
          "target": {
            "block": "ce0bb6e1-53ec-4758-b201-e1354c2e1277",
            "port": "in"
          },
          "size": 4
        }
  ...
  "dependencies": {
    ...
    "d9c67be24d4a8c4c5416df39f3731d1307e553b7": {
      "package": {
        "name": "Bank-4x1-paralell-blocks",
        "version": "0.1",
        "description": "Bank of 4 registers of 1 bits with paralell output  (implemented with blocks)",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "5a0600ef-d40c-4ab5-bc05-3255dfb1fd88",
              "type": "basic.inputLabel",
              "data": {
                "blockColor": "fuchsia",
                "name": "bit3",
            ...
            {
              "id": "7fd08203-31df-4801-8a25-5629262e512c",
              "type": "basic.outputLabel",
              "data": {
                "blockColor": "fuchsia",
                "name": "bit3",
            ...
            {
              "id": "35cd03cf-c40d-40b5-b6b7-ab45dc782398",
              "type": "basic.outputLabel",
              "data": {
                "blockColor": "fuchsia",
                "name": "bit2",
            ...
            {
              "id": "dcb044dd-f9b7-41d7-b682-40769de6c12f",
              "type": "basic.outputLabel",
              "data": {
                "blockColor": "fuchsia",
                "name": "bit1",
            ...
            {
              "id": "8872e5d9-8f6d-4096-94b9-3b6cb1f7ea4e",
              "type": "basic.output",
              "data": {
                "name": "paralell",
                "range": "[3:0]",
            ...
            {
              "id": "40fbd764-b47f-414f-a8f4-a492d7b0d3d0",
              "type": "basic.inputLabel",
              "data": {
                "blockColor": "fuchsia",
                "name": "bit2",
            ...
            {
              "id": "df9a2e9a-cc3c-46df-ab7f-deec4df4d6bf",
              "type": "basic.outputLabel",
              "data": {
                "blockColor": "fuchsia",
                "name": "bit0",
            ...
            {
              "id": "5e42c660-c8f5-4c67-ac7c-16283a249fb6",
              "type": "basic.inputLabel",
              "data": {
                "blockColor": "fuchsia",
                "name": "bit1",
            ...
            {
              "id": "2619b9cf-46d9-42bc-85f1-58ce00d510f0",
              "type": "basic.inputLabel",
              "data": {
                "blockColor": "fuchsia",
                "name": "bit0",
            ...
            {
              "id": "897b6d55-05eb-4ccb-81ca-1db6af76eb7e",
            ...
            {
              "id": "57d9b446-424d-4b2c-9c4d-017184b15343",
              "type": "basic.info",
              "data": {
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "2619b9cf-46d9-42bc-85f1-58ce00d510f0",
                "port": "inlabel"
              }
            },
            {
              ...
              "target": {
                "block": "5e42c660-c8f5-4c67-ac7c-16283a249fb6",
                "port": "inlabel"
              }
            },
            {
              ...
              "target": {
                "block": "40fbd764-b47f-414f-a8f4-a492d7b0d3d0",
                "port": "inlabel"
              }
            },
            {
              ...
              "target": {
                "block": "5a0600ef-d40c-4ab5-bc05-3255dfb1fd88",
                "port": "inlabel"
              }
            },
            {
              "source": {
                "block": "7fd08203-31df-4801-8a25-5629262e512c",
                "port": "outlabel"
              },
              "target": {
                "block": "897b6d55-05eb-4ccb-81ca-1db6af76eb7e",
                "port": "9db42483-957c-4490-84d2-5df273d2abd2"
              }
            },
            {
              "source": {
                "block": "df9a2e9a-cc3c-46df-ab7f-deec4df4d6bf",
                "port": "outlabel"
              },
              "target": {
                "block": "897b6d55-05eb-4ccb-81ca-1db6af76eb7e",
            ...
            {
              "source": {
                "block": "dcb044dd-f9b7-41d7-b682-40769de6c12f",
                "port": "outlabel"
              },
              "target": {
                "block": "897b6d55-05eb-4ccb-81ca-1db6af76eb7e",
            ...
            {
              "source": {
                "block": "35cd03cf-c40d-40b5-b6b7-ab45dc782398",
                "port": "outlabel"
              },
              "target": {
                "block": "897b6d55-05eb-4ccb-81ca-1db6af76eb7e",
            ...
            },
            {
              ...
              "target": {
                "block": "8872e5d9-8f6d-4096-94b9-3b6cb1f7ea4e",
                "port": "in"
              },
              "size": 4
            }
