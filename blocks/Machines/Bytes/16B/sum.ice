{
  "version": "1.2",
  "package": {
    "name": "Mem-16B-sum-machine",
    "version": "0.1",
    "description": "16B memory sum. Calculates M0 = M1 + M2 + ..+ M15",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "d0562dd1-cb0d-48bb-a019-abebf4d1723e",
        ...
        {
          "id": "0f78485f-630c-4b74-8732-b5848c37e8e7",
          "type": "basic.outputLabel",
          "data": {
            "name": "mbi",
            "range": "[13:0]",
        ...
        {
          "id": "a220ee27-61d3-4792-9b9a-e626a0f84c4f",
          "type": "basic.output",
          "data": {
            "name": "mbo",
            "range": "[13:0]",
        ...
        {
          "id": "7c9d75b9-32d8-4f26-b6f9-9a37651d1e53",
          "type": "basic.input",
          "data": {
            "name": "mbus",
            "range": "[13:0]",
        ...
        {
          "id": "fa4aa805-0645-47e4-aee0-20eed03d27ad",
          "type": "basic.inputLabel",
          "data": {
            "name": "mbi",
            "range": "[13:0]",
        ...
        {
          "id": "5043d3f8-52e6-468a-89f8-9e4e688eedfe",
          "type": "basic.outputLabel",
          "data": {
            "name": "mbi",
            "range": "[13:0]",
        ...
        {
          "id": "e90f4022-f939-4ebe-b7c7-d676e710ff5b",
          "type": "basic.inputLabel",
          "data": {
            "name": "addr",
            "range": "[3:0]",
        ...
        },
        {
          ...
          "data": {
            ...
            "list": "//-- addr wr rst ldA\n0001_0_1_0  //-- A = 0, Lec M1\n0010_0_0_1  //-- A = 0 + M1, Lec M2\n0011_0_0_1  //-- A = A + M2, Lec M3\n0100_0_0_1  //-- A = A + M3, Lec M4\n0101_0_0_1  //-- A = A + M4, Lec M5\n0110_0_0_1  //-- A = A + M5, Lec M6\n0111_0_0_1  //-- A = A + M6, Lec M7\n1000_0_0_1  //-- A = A + M7, Lec M8\n1001_0_0_1  //-- A = A + M8, Lec M9\n1010_0_0_1  //-- A = A + M9, Lec M10\n1011_0_0_1  //-- A = A + M10, Lec M11\n1100_0_0_1  //-- A = A + M11, Lec M12\n1101_0_0_1  //-- A = A + M12, Lec M13\n1110_0_0_1  //-- A = A + M13, Lec M14\n1111_0_0_1  //-- A = A + M14, Lec M15\n0000_0_0_1  //-- A = A + M15\n0000_1_0_0  //-- M0 = A\n",
            "local": true,
            "format": 10
          },
          "position": {
        ...
        {
          "id": "a56f02b4-e4e3-4d43-9071-ce5797d0dd59",
        ...
        {
          "id": "e30e1158-55eb-4371-b634-fea99da8f7fe",
        ...
        {
          "id": "93dae9cd-abd8-4100-8578-16cd80df000b",
        ...
        {
          "id": "8c58293a-f036-4b5b-96ef-88c7e4946c31",
        ...
        {
          "id": "a0e4f659-7fc8-4cf7-8119-82d2e96446b5",
          "type": "a2804ac20b5aeb0163118878164f03f8d27d2ccb",
          "position": {
            "x": 912,
            "y": 1248
          },
        ...
        {
          "id": "b9078d39-cdc2-40ac-9179-683333230015",
        ...
        {
          "id": "0a710790-d188-49d0-a768-8ba1c2dd83e0",
          "type": "1aff079050af118d0d3b79452d427f72cd430ade",
          "position": {
            "x": 1296,
            "y": 1264
          },
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "a56f02b4-e4e3-4d43-9071-ce5797d0dd59",
        ...
        },
        {
          ...
          "target": {
            "block": "e30e1158-55eb-4371-b634-fea99da8f7fe",
        ...
        {
          "source": {
            "block": "8c58293a-f036-4b5b-96ef-88c7e4946c31",
        ...
        },
        {
          ...
          "target": {
            "block": "b9078d39-cdc2-40ac-9179-683333230015",
        ...
        {
          "source": {
            "block": "7c9d75b9-32d8-4f26-b6f9-9a37651d1e53",
            "port": "out",
            "size": 14
          },
          "target": {
            "block": "fa4aa805-0645-47e4-aee0-20eed03d27ad",
            "port": "inlabel"
          },
          "vertices": [],
          "size": 14
        ...
        {
          "source": {
            "block": "5043d3f8-52e6-468a-89f8-9e4e688eedfe",
            "port": "outlabel"
          },
          "target": {
            "block": "a56f02b4-e4e3-4d43-9071-ce5797d0dd59",
        ...
        {
          "source": {
            "block": "d0562dd1-cb0d-48bb-a019-abebf4d1723e",
            "port": "outlabel"
          },
          "target": {
            "block": "e30e1158-55eb-4371-b634-fea99da8f7fe",
        ...
        {
          "source": {
            "block": "0f78485f-630c-4b74-8732-b5848c37e8e7",
            "port": "outlabel"
          },
          "target": {
            "block": "93dae9cd-abd8-4100-8578-16cd80df000b",
        ...
        {
          "source": {
            "block": "0a710790-d188-49d0-a768-8ba1c2dd83e0",
            "port": "3a22d0e6-f7d1-4f09-a98b-e80e769977a9",
            "size": 4
          },
          "target": {
            "block": "e90f4022-f939-4ebe-b7c7-d676e710ff5b",
            "port": "inlabel"
          },
          "size": 4
        },
        ...
        },
        {
          ...
          "target": {
            "block": "a0e4f659-7fc8-4cf7-8119-82d2e96446b5",
        ...
        },
        {
          "source": {
            "block": "0a710790-d188-49d0-a768-8ba1c2dd83e0",
            "port": "130cadf3-fcb0-47b3-8f9e-552423743f67"
          },
          "target": {
            "block": "f9aa6908-030c-4c3b-8a08-9839f74a7790",
        ...
        },
        {
          ...
          "target": {
            "block": "a220ee27-61d3-4792-9b9a-e626a0f84c4f",
            "port": "in"
          },
          "size": 14
        },
  ...
  "dependencies": {
    ...
    "a2804ac20b5aeb0163118878164f03f8d27d2ccb": {
      "package": {
        "name": "mi-tabla5-7",
        "version": "0.1",
        "description": "Circuito combinacional de 5 entradas y 7 salidas",
    ...
    "1aff079050af118d0d3b79452d427f72cd430ade": {
      "package": {
        "name": "Split-4-3",
        "version": "0.1",
        "description": "Split a 7-bits-buts into two: 4-bits and 3-bits",
        "author": "Juan González-Gómez (Obijuan)",
        "image": "%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%22354.768%22%20height=%22241.058%22%20viewBox=%220%200%20332.59497%20225.99201%22%3E%3Cpath%20d=%22M168.377%2077.643l61.147-60.938C240.21%206.25%20254.56.461%20269.484.5h62.611v26.186l-61.698.046c-8.012-.043-15.705%203.133-21.47%208.81L187.48%2096.857a57.292%2057.292%200%200%201-39.993%2016.139%2057.292%2057.292%200%200%201%2039.993%2016.14l61.448%2061.314c5.765%205.677%2013.458%208.853%2021.47%208.81l61.698.046v26.186h-62.612c-14.924.039-29.463-5.9-40.204-16.28l-60.902-60.863a29.857%2029.857%200%200%200-21.347-8.81L.5%20139.427V86.457h146.524a29.884%2029.884%200%200%200%2021.353-8.814z%22%20fill=%22green%22%20stroke=%22#000%22%20stroke-linecap=%22round%22%20stroke-linejoin=%22round%22/%3E%3C/svg%3E"
      },
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "3a22d0e6-f7d1-4f09-a98b-e80e769977a9",
              "type": "basic.output",
              "data": {
                "name": "o1",
                "range": "[3:0]",
            ...
            {
              "id": "130cadf3-fcb0-47b3-8f9e-552423743f67",
              "type": "basic.output",
              "data": {
                "name": "o0",
                "range": "[2:0]",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "130cadf3-fcb0-47b3-8f9e-552423743f67",
                "port": "in"
              },
              "size": 3
            },
            {
              ...
              "target": {
                "block": "3a22d0e6-f7d1-4f09-a98b-e80e769977a9",
                "port": "in"
              },
              "size": 4
            }
