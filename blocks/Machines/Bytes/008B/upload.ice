{
  "version": "1.2",
  "package": {
    "name": "Mem-8B-upload-machine",
    "version": "0.2",
    "description": "8B memory upload machine. Initilize the memory with data from the stdin",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "51e4d8b0-e2e2-4375-ae91-6eb7e5374783",
        ...
        {
          "id": "e3e06cbb-e22e-4d05-8f93-6656f317ed5e",
          "type": "basic.output",
          "data": {
            "name": "mbo",
            "range": "[12:0]",
        ...
        {
          "id": "728d77ca-e3d7-4757-ac65-e3598b92830a",
          "type": "basic.outputLabel",
          "data": {
            "name": "mbi",
            "range": "[12:0]",
        ...
        {
          "id": "8df8195f-bf96-40ae-892d-96edc27c2265",
          "type": "basic.outputLabel",
          "data": {
            "name": "mbi",
            "range": "[12:0]",
        ...
        {
          "id": "dc4810bf-d8d6-4ccd-a4c7-f52017fef6a0",
          "type": "basic.input",
          "data": {
            "name": "mbus",
            "range": "[12:0]",
        ...
        {
          "id": "97bcf40f-eca4-400c-87d9-7013f44e0351",
          "type": "basic.inputLabel",
          "data": {
            "name": "mbi",
            "range": "[12:0]",
        ...
        {
          "id": "145fd592-37d4-43dd-811b-c316110c31ef",
          "type": "basic.inputLabel",
          "data": {
            "name": "addr",
            "range": "[2:0]",
        ...
        {
          "id": "9d000c1d-4111-4f2c-8535-f36a43b8b9c0",
        ...
        {
          "id": "9536aa49-de41-4d2a-9d71-4e1f22d4f85e",
        ...
        {
          "id": "3993caf4-3f82-471a-8fc5-168abf6160a2",
        ...
        {
          "id": "6b404ea2-8f6c-42c4-9864-3c4bb64052cf",
        ...
        {
          "id": "540d67e1-74d2-41f5-a5e3-4c4525419bf5",
          "type": "58ed2b5c7e33e2f215ccba6c101d9ea4ff60f284",
          "position": {
            "x": 1808,
            "y": 280
        ...
        {
          "id": "22e311da-eada-4e64-9726-c33e964d91a0",
        ...
        {
          "id": "be3b3709-3163-469c-948a-8b61c860e817",
        ...
        {
          "id": "280c7cf6-1d2c-4b1e-8ace-9ac383b9dc87",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "9d000c1d-4111-4f2c-8535-f36a43b8b9c0",
        ...
        },
        {
          ...
          "target": {
            "block": "3993caf4-3f82-471a-8fc5-168abf6160a2",
        ...
        },
        {
          ...
          "target": {
            "block": "9536aa49-de41-4d2a-9d71-4e1f22d4f85e",
        ...
        },
        {
          ...
          "target": {
            "block": "540d67e1-74d2-41f5-a5e3-4c4525419bf5",
        ...
        },
        {
          ...
          "target": {
            "block": "be3b3709-3163-469c-948a-8b61c860e817",
        ...
        },
        {
          ...
          "target": {
            "block": "6b404ea2-8f6c-42c4-9864-3c4bb64052cf",
            "port": "bf2f0c53-2d04-4cba-aa70-2df85502d24f"
          }
        },
        {
        ...
        {
          "source": {
            "block": "dc4810bf-d8d6-4ccd-a4c7-f52017fef6a0",
            "port": "out",
            "size": 13
          },
          "target": {
            "block": "97bcf40f-eca4-400c-87d9-7013f44e0351",
            "port": "inlabel"
          },
          "vertices": [],
          "size": 13
        ...
        {
          "source": {
            "block": "8df8195f-bf96-40ae-892d-96edc27c2265",
            "port": "outlabel"
          },
          "target": {
            "block": "9d000c1d-4111-4f2c-8535-f36a43b8b9c0",
        ...
        {
          "source": {
            "block": "51e4d8b0-e2e2-4375-ae91-6eb7e5374783",
            "port": "outlabel"
          },
          "target": {
            "block": "9536aa49-de41-4d2a-9d71-4e1f22d4f85e",
        ...
        },
        {
          ...
          "target": {
            "block": "145fd592-37d4-43dd-811b-c316110c31ef",
            "port": "inlabel"
          },
          "size": 3
        },
        ...
        {
          "source": {
            "block": "728d77ca-e3d7-4757-ac65-e3598b92830a",
            "port": "outlabel"
          },
          "target": {
            "block": "280c7cf6-1d2c-4b1e-8ace-9ac383b9dc87",
        ...
        },
        {
          ...
          "target": {
            "block": "e3e06cbb-e22e-4d05-8f93-6656f317ed5e",
            "port": "in"
          },
          "size": 13
        },
        {
          "source": {
            "block": "22e311da-eada-4e64-9726-c33e964d91a0",
