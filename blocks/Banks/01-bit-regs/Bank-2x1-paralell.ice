{
  "version": "1.2",
  "package": {
    "name": "Bank-2x1-paralell",
    "version": "0.1",
    "description": "Bank of 2 registers of 1 bits (implemented in verilog). Addition output in paralell",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "c6a724da-96d3-4ae8-bbcb-35a80891ba36",
          "type": "basic.output",
          "data": {
            "name": "paralell",
            "range": "[1:0]",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "c6a724da-96d3-4ae8-bbcb-35a80891ba36",
            "port": "in"
          },
          "size": 2
        }
