{
  "version": "1.2",
  "package": {
    "name": "Bank-8x1-paralell-blocks",
    "version": "0.1",
    "description": "Bank of 8 registers of 1 bits with paralell output (implemented with blocks)",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "e76133f0-9cd3-4c70-9cfb-c91a642f84c9",
          "type": "basic.outputLabel",
          "data": {
            "blockColor": "fuchsia",
            "name": "par1",
        ...
        {
          "id": "83011776-cdcf-4d95-aa2e-21a35159258d",
          "type": "basic.output",
          "data": {
            "name": "paralell",
            "range": "[7:0]",
        ...
        {
          "id": "13f9bb84-587b-4a3a-b1a9-6749f23a085f",
          "type": "basic.inputLabel",
          "data": {
            "blockColor": "fuchsia",
            "name": "par1",
        ...
        {
          "id": "fcde23f6-cd6e-4aa1-90f1-696d1ffa977d",
          "type": "basic.outputLabel",
          "data": {
            "blockColor": "fuchsia",
            "name": "par0",
        ...
        {
          "id": "6ce5b1d2-a8e5-4a97-8a7d-e9f4b29d2bbf",
          "type": "basic.inputLabel",
          "data": {
            "blockColor": "fuchsia",
            "name": "par0",
        ...
        {
          "id": "07ebb690-1d7d-44e3-9384-2d8b305f7cc7",
          "type": "2cdac39f596bf28844cb144eacfdcb0d3b91d436",
          "position": {
            "x": 784,
            "y": 288
          },
        ...
        {
          "id": "8466d8dc-b91d-4ec4-b711-f0170877691f",
          "type": "2cdac39f596bf28844cb144eacfdcb0d3b91d436",
          "position": {
            "x": 784,
            "y": 608
        ...
        {
          "id": "a8ab4f32-4640-4bbb-b8ba-08bd18b4e909",
        ...
        {
          "id": "4c3b097f-7c26-4906-8dca-1a5cf42c9f28",
          "type": "basic.info",
          "data": {
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "8466d8dc-b91d-4ec4-b711-f0170877691f",
        ...
        },
        {
          ...
          "target": {
            "block": "07ebb690-1d7d-44e3-9384-2d8b305f7cc7",
            "port": "cc304f00-4dfa-4384-aa97-3c0348989a96"
          }
        },
        {
        ...
        },
        {
          ...
          "target": {
            "block": "07ebb690-1d7d-44e3-9384-2d8b305f7cc7",
            "port": "54558815-d497-4950-8239-bbaa5a5a7bc4",
            "size": 2
          },
          "size": 2
        },
        ...
        },
        {
          "source": {
            "block": "8466d8dc-b91d-4ec4-b711-f0170877691f",
            "port": "7537df40-6efa-4a3b-a39d-a4049a5076c4",
            "size": 4
          },
          "target": {
            "block": "6ce5b1d2-a8e5-4a97-8a7d-e9f4b29d2bbf",
            "port": "inlabel"
          },
          "size": 4
        },
        {
          ...
          "target": {
            "block": "13f9bb84-587b-4a3a-b1a9-6749f23a085f",
            "port": "inlabel"
          },
          "size": 4
        },
        {
          "source": {
            "block": "e76133f0-9cd3-4c70-9cfb-c91a642f84c9",
            "port": "outlabel"
          },
          "target": {
            "block": "a8ab4f32-4640-4bbb-b8ba-08bd18b4e909",
        ...
        {
          "source": {
            "block": "fcde23f6-cd6e-4aa1-90f1-696d1ffa977d",
            "port": "outlabel"
          },
          "target": {
            "block": "a8ab4f32-4640-4bbb-b8ba-08bd18b4e909",
        ...
        },
        {
          ...
          "target": {
            "block": "83011776-cdcf-4d95-aa2e-21a35159258d",
            "port": "in"
          },
          "size": 8
        }
  ...
  "dependencies": {
    ...
    "2cdac39f596bf28844cb144eacfdcb0d3b91d436": {
      "package": {
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "7537df40-6efa-4a3b-a39d-a4049a5076c4",
              "type": "basic.output",
              "data": {
                "name": "paralell",
                "range": "[3:0]",
            ...
            {
              "id": "6caf3042-3ee1-4896-8d97-473603fc5e79",
              "type": "basic.outputLabel",
              "data": {
                "name": "addr",
                "range": "[1:0]",
            ...
            {
              "id": "5cc6cad3-dee2-4d12-84a6-d5f677d33eb8",
              "type": "basic.inputLabel",
              "data": {
                "name": "addr",
                "range": "[1:0]",
            ...
            {
              "id": "54558815-d497-4950-8239-bbaa5a5a7bc4",
              "type": "basic.input",
              "data": {
                "name": "addr",
                "range": "[1:0]",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "6caf3042-3ee1-4896-8d97-473603fc5e79",
                "port": "outlabel"
              },
              "target": {
                "block": "f67e4c13-cb1a-4f3f-95aa-0b1768893b03",
            ...
            {
              "source": {
                "block": "54558815-d497-4950-8239-bbaa5a5a7bc4",
                "port": "out",
                "size": 2
              },
              "target": {
                "block": "5cc6cad3-dee2-4d12-84a6-d5f677d33eb8",
                "port": "inlabel"
              },
              "size": 2
            },
            ...
            },
            {
              ...
              "target": {
                "block": "7537df40-6efa-4a3b-a39d-a4049a5076c4",
                "port": "in"
              },
              "size": 4
            }
